...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String pM = "CREATE TABLE PhieuMuon (idPM INTEGER PRIMARY KEY AUTOINCREMENT, tenSach TEXT, ngayTra DATE, ngayMuon DATE, soLuong INTEGER ,gia REAL, trangThai INTEGER, tenTV TEXT)";
        db.execSQL(pM);
